...
local theme = lush(function()
  return {
    ...
    DiffAdd      { bg = colors.emerald }, -- Diff mode: Added line |diff.txt|
    DiffChange   { bg = colors.amethyst }, -- Diff mode: Changed line |diff.txt|
    ...
    PmenuSbar    { bg = colors.carbon_darker, fg = colors.carbon }, -- Popup menu: Scrollbar.
    ...
    StatusLine   { bg = colors.steel_lighter, fg = colors.carbon_darker }, -- Status line of current window
    StatusLineNC { bg = colors.carbon_darker, fg = colors.carbon_darker }, -- Status lines of not-current windows. Note: If this is equal to "StatusLine" Vim will use "^^^" in the status line of the current window.
    ...
    Visual       { bg = colors.carbon_darker }, -- Visual mode selection
